...
/log                → Build in public feed (MDX files, no CMS)
...
Vercel deployment, Resend for email capture, 
Vercel Analytics, MDX for build log content.
...
├── /                    → Hero + Tools grid + Build log preview + Email signup
├── /tools               → All tools (live, beta, coming soon)
├── /tools/[slug]        → Individual tool page (SEO + launch page)
├── /log                 → Build in public feed
├── /log/[slug]          → Individual log post (MDX)
├── /about               → Who you are, how you work, your stack
├── /privacy             
└── /terms               
```
