...
> Note: This prompt is a reference template. It assumes your project has a `content/tools/` directory with a tool registry pattern. Copy it into your project’s `.github/prompts/` to activate the `/tool` command.
